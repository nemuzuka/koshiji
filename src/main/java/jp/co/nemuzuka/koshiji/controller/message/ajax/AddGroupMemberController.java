 ...
 * @author kazumune
 */
public class AddGroupMemberController extends JsonController {
	...
	protected Object execute() throws Exception {
	    memberCreateService.createNormalMember(asString("mail"), getUserInfo().selectedGroupKeyString);
    ...
    protected Validators validate() {
        ...
        v.add("mail", v.required(), v.maxlength(256));
        return v;
    }
}
