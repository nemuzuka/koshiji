 ...
 * @author kazumune
 */
public class DeleteCommentController extends JsonController {
	...
	protected Object execute() throws Exception {
        ...
        Key commentKey = Datastore.stringToKey(asString("commentKeyString"));
        
        messageEditService.deleteComment(messageKey, commentKey, memberKey);
