...
import jp.co.nemuzuka.koshiji.service.MessageSearchService.GroupUnreadMessage;
...
/**
 * ログインユーザにおけるグループ毎の未読Message件数を検索します。
 * @author kazumune
 */
public class UnreadMessage4LoginController extends JsonController {
	...
	protected Object execute() throws Exception {
	    ...
	    List<GroupUnreadMessage> list = messageSearchService.getGroupUnreadMessage(memberKey, userInfo.groupList);
