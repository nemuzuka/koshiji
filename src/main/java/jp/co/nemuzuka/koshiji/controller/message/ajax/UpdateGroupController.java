...
import jp.co.nemuzuka.koshiji.service.impl.GroupManagerServiceImpl;
 ...
 * @author kazumune
 */
public class UpdateGroupController extends JsonController {
    
    private GroupManagerService groupManagerService = GroupManagerServiceImpl.getInstance();
	...
	protected Object execute() throws Exception {
	    ...
	    param.deleteMemberKeyStrings = paramValues("deleteMembers[]");
	    if(param.deleteMemberKeyStrings == null) {
	        param.deleteMemberKeyStrings = new String[0];
	    }
	    param.groupKeyString = getUserInfo().selectedGroupKeyString;
	    param.groupName = asString("groupName");
	    param.versionNo = asString("versionNo");
	    
	    groupManagerService.put(param, Datastore.stringToKey(getUserInfo().keyToString));
